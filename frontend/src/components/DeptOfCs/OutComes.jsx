...
export default function OutComes() {
  return (
    <>
                <section className=" bg-[#0f0e0e] overflow-hidden">
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-bold text-gray-800 capitalize lg:text-4xl dark:text-white">Outcomes</h1>

        <div className="mt-2">
            <span className="inline-block w-40 h-1 bg-[#E77500] rounded-full"></span>
            <span className="inline-block w-3 h-1 ml-1 bg-[#E77500] rounded-full"></span>
            <span className="inline-block w-1 h-1 ml-1 bg-[#E77500] rounded-full"></span>
        </div>

        <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
            <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                <div className="space-y-3">
                    <span className="inline-block p-3 text-blue-500 rounded-xl dark:text-white dark:bg-[#E77500]">
                ...
                <div className="space-y-3">
                    <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-xl dark:text-white dark:bg-[#E77500]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
