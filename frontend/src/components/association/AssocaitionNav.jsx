            ...
            <div  className={`${isColpase?"translate-x-0 opacity-100":"opacity-0 -translate-x-full"} absolute inset-x-0 z-20 flex-1 w-full px-6  py-4 transition-all duration-300 ease-in-out bg-[#151515] lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-end justify-between`}>
                <div className="flex flex-col font-semibold text-white xl:text-lg md:text-lg text-sm lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
                    ...
                    <div className="relative mt-4 lg:mt-0 lg:mx-4">
                        ...
                        <input onChange={(e) => handleSearch(e.target.value)} type="text"   value={searchQuery} className="w-full py-1 pl-10 pr-4 text-gray-700 placeholder-gray-600 bg-[#292929] border-b border-gray-600 dark:placeholder-[#d4d4d4] dark:focus:border-gray-300 lg:w-56 lg:border-transparent focus:outline-none focus:border-gray-600" placeholder="Search"/>
            ...
            <ul className="absolute z-10 w-full mt-2 bg-white border border-gray-300 rounded-md shadow-lg">
              {filteredSuggestions.map((suggestion) => (
                ...
                onClick={()=>suggestionTrigger(suggestion)}
                  key={suggestion.id}
                  className="px-4 py-2 text-gray-800 border-b border-gray-300 cursor-pointer hover:bg-gray-100"
                >
