...
<form>
   <div className="w-[100%] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-200 dark:border-gray-600">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-[#111111]">
           <label htmlFor="editor" className="sr-only">Publish Announcement for {forwho}</label>
           <textarea
  id="editor"
  rows="8"
  style={{ resize: 'both' }}
...
></textarea>
   ...
   <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-orange-700 rounded-lg focus:ring-4 focus:ring-orange-200 dark:focus:ring-orange-900 hover:bg-orange-800">
